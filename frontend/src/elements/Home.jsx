...
const Home = () => {
  return (
    <>
      <div id="heroSect">
        <div className="bg-transparent w-11/12 md:w-9/12 h-screen flex flex-col justify-center items-center gap-8 mx-auto">
          <div className=" w-3/4 text-center text-clip font-bold text-4xl md:text-7xl">
            Improve your Producti
            <strong className="text-purple-900"> vity</strong>
          </div>
          <ButtonCompact path="/login" value="Try Now" />
        </div>
      </div>
      ...
      <div className="w-11/12 md:w-9/12 mx-auto pb-24 h-auto">
        <div className="flex justify-start mb-28">
          <Card
            imgSrc="https://mdbootstrap.com/wp-content/uploads/2020/06/vertical.jpg"
            title="Test title"
